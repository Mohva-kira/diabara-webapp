...
const Login = ({ switchPage, switchModeHandler, login, isFetching, history }) => {
  ...
  const from = location.state?.from || "/"; // Default to the home page
    ...
    <section className="">
      <div className="h-full">
        <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
          <p className="w-full flex relative roudend-lg  items-center justify-center flex-wrap gap-2 mb-0 mt-2 pt-1 text-sm font-semibold">
            <img src={sing} width="350px" height="auto" />
            <motion.button
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
              onClick={() => navigate("/adhesion")}
              className="mt-3 text-xl absolute top-32 md:right-[450px] right-12 text-white bg-orange-600 rounded-lg p-1  transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700">
              Je suis un artiste
            </motion.button>
          </p>
