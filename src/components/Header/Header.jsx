...
const Header = () => {
  ...
  return (
    <header className="bg-[#191624] px-2  min-[320px]  py-4 ">
      <nav
        className="mx-auto flex max-w-7xl items-center justify-between md:mt-0 mt-8  px-10 lg:px-8"
        aria-label="Global">
        <Searchbar className="w-full" />

        <div className="flex lg:hidden absolute md:hidden block mt-6 right-5">
          <button
            type="button"
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Popover className="relative">
            <Popover.Button className="flex  justify-center items-center flex-wrap gap-2 text-sm font-semibold text-orange-500 hover:text-cyan-400">
              <a
                href="/auth"
                className="font-semibold  flex justify-center items-center leading-6  text-gray-400 hover:text-cyan-400">
                <div className=" text-white text-xs p-2">
                  <p className=" shadow-inner px-2 py-1 rounded-lg border-b border-orange-500 font-semibold">
                    {user ? user.nickName : ""}
                  </p>
                </div>

                <div className="w-5 mt-1 ">
                  <p className="  bg-gradient-to-br bg-gradi text-sm text-white rounded-full">
                    {" "}
                    <UserIcon fontSize={4} />{" "}
                  </p>
                </div>
                  ...
                  {({ open }) => (
                    <>
                      <Disclosure.Button className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 hover:bg-gray-50">
                        ...
                        />
                        <div
                          className={` ${classNames(open ? "text-gray-700" : "text-white")} w-full text-xs p-2`}>
