...
import { useGetFavoritesByUserQuery } from '../redux/services/favorites';
...
const Profile = () => {
  ...
  const { data: favData, isLoading: favIsLoading, isFetching: favFetching, isSuccess: favSuccess } = useGetFavoritesByUserQuery(
    user.id
  );
  ...
  return (
    <section class="bg-white/30 py-8 antialiased dark:bg-gray-900/30 md:py-8">
    <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          ...
          <li>
            <div class="flex items-center">
              ...
              <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white md:ms-2">Mon compte</a>
            </div>
          </li>
          <li aria-current="page">
            <div class="flex items-center">
              ...
              <span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">Profile</span>
            </div>
          </li>
        </ol>
      </nav>
      <div className='flex justify-between'>
      <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl md:mb-6">Vue d'ensemble</h2>
      ...
      <div class="grid grid-cols-2 gap-6 border-b border-t border-gray-200 py-4 dark:border-gray-700 md:py-8 lg:grid-cols-4 xl:gap-16">
        <div>
          ...
          <h3 class="mb-2 text-gray-500 dark:text-gray-400">Formules</h3>
        ...
        <div>
          ...
          <h3 class="mb-2 text-gray-500 dark:text-gray-400">Follow</h3>
          <span class="flex items-center text-2xl font-bold text-gray-900 dark:text-white"
            >16
            <span class="ms-2 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">
              <svg class="-ms-1 me-1 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <h3 class="mb-2 text-gray-500 dark:text-gray-400">Favoris</h3>
          <span class="flex items-center text-2xl font-bold text-gray-900 dark:text-white"
            >{favData?.data.length}
        ...
        <div class="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
          <div class="space-y-4">
            <div class="flex space-x-4">
              ...
              <div>
                <span class="mb-2 inline-block rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-slate-100 dark:text-primary-300"> PRO Account </span>
                <h2 class="flex items-center text-xl font-bold leading-none text-gray-900 dark:text-white sm:text-2xl">{`${user.firstName} ${user.lastName}`}</h2>
              </div>
            </div>
            <dl class="">
              <dt class="font-semibold text-gray-900 dark:text-white">Email </dt>
              <dd class="text-gray-500 dark:text-gray-400">{`${user.email ? user.email : 'email non disponible'}`}</dd>
            </dl>
            <dl>
              ...
              <dd class="flex items-center gap-1 text-gray-500 dark:text-gray-400">
                ...
                {`${user.adress} ${user.ville} ${user.Pays}`}
              </dd>
            </dl>
          ...
          <div class="space-y-4">
            <dl>
              ...
              <dd class="text-gray-500 dark:text-gray-400">{user.username}</dd>
            </dl>
            <dl>
